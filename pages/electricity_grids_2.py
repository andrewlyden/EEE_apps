...
@callback(
    ...
    Output("unified-costs2", "children"),
    Output("redispatch-costs2", "children"),
...
def calc(wind_capacity_scotland, wind_capacity_england, wind_capacity_wales,
    ...
    network_redispatch.generators.loc[network_redispatch.generators.index.str.contains("ramp up"), "marginal_cost"] *= 2
    network_redispatch.generators.loc[network_redispatch.generators.index.str.contains("ramp down"), "marginal_cost"] *= -0.5
